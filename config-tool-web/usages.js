const usages = {
    ...
    'source': {
        ...
        "0x000c0030": { 'name': 'Power', 'class': 'media' },
        "0x000c0032": { 'name': 'Sleep', 'class': 'media' },
        "0x000c0040": { 'name': 'Menu', 'class': 'media' },
        "0x000c0041": { 'name': 'DPAD Center', 'class': 'media' },
        "0x000c0042": { 'name': 'DPAD Up (Consumer)', 'class': 'media' },
        "0x000c0043": { 'name': 'DPAD Down (Consumer)', 'class': 'media' },
        "0x000c0044": { 'name': 'DPAD Left (Consumer)', 'class': 'media' },
        "0x000c0045": { 'name': 'DPAD Right (Consumer)', 'class': 'media' },
        "0x000c0046": { 'name': 'Escape (Consumer)', 'class': 'media' },
        "0x000c0060": { 'name': 'Info', 'class': 'media' },
        "0x000c0061": { 'name': 'Captions', 'class': 'media' },
        ...
        "0x000c00cf": { 'name': 'Voice command', 'class': 'media' },
        ...
        "0x000c01a2": { 'name': 'App switch', 'class': 'media' },
        "0x000c01cb": { 'name': 'Assistant', 'class': 'media' },
